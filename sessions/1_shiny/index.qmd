...
![](../../assets/images/1_shiny/inputs.png){fig-align="center"} ::: {.incremental}
...
We define the following objective function, $y_i$ being the observed data and $f(x_i, \beta)$ the model predictions:
